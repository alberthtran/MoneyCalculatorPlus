...
//  pocketCalc
//
//  Created by Albert Tran on 9/14/11.
...
@implementation IOUHistory

@synthesize iou_record,purchased_date,email_msg,shareAgain;
...
- (void) viewWillAppear:(BOOL)animated {
    ...
    NSDate *myDate = [iou_record objectForKey:PURCHASED_DATE_KEY];
    NSDateFormatter *df = [NSDateFormatter new];
    [df setDateFormat:DISPLAY_DATE_FORMAT];
    
    self.title = IOU_TAG;
    purchased_date.text = [df stringFromDate:myDate];
	email_msg.text = [iou_record objectForKey:EMAIL_MSG_KEY];   
