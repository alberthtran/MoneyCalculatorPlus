...
@implementation DealHistory

@synthesize deal_record,purchased_date,email_msg,shareAgain;
...
- (void) viewWillAppear:(BOOL)animated {
    ...
    NSDate *myDate = [deal_record objectForKey:PURCHASED_DATE_KEY];
    NSDateFormatter *df = [NSDateFormatter new];
    [df setDateFormat:DISPLAY_DATE_FORMAT];
    
    self.title = [deal_record objectForKey:PURCHASED_ITEM_KEY];
    purchased_date.text = [df stringFromDate:myDate];
	email_msg.text = [deal_record objectForKey:EMAIL_MSG_KEY];   
